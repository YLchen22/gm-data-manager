...
- 数据权限边界（已确认）：当前 token 下历史退市股数据不可获取（get_symbols/get_history_instruments/退市股 history 均返回 1000）；2016 有效集合约 2427 只 vs 当年实际约 2800+，缺口为已退市股票。系统保证权限范围内完整性，缺口在 WebUI 标注。
